...
if __name__ == '__main__':
    ...
    parser.add_argument('--tag', type=str, default='GraphPT', help='Name tag')
    ...
    parser.add_argument('--nepoch', nargs='+', type=int, default=[5], help='Number of epochs (Single value for combined training; Array for one-by-one training)')
    parser.add_argument('--nevt', type=int, default=100, help='Number of events')
    parser.add_argument('--nevt_val', type=int, default=20, help='Number of events for validation')
    ...
    parser.add_argument('--dataset_train', type=str, default='./data/dataset_nevt100.root', help='Training dataset')
    parser.add_argument('--dataset_test', type=str, default='./data/dataset_nevt20.root', help='Testing dataset')
    parser.add_argument('--prob_cut', type=float, default=0.5, help='Probability cut')
    parser.add_argument('--model_layers', nargs='+', type=int, default=(4, 8, 16), help='Number of layers')
    ...
    parser.add_argument('--dataset_rec', type=str, default='./data/dataset_nevt20.root', help='Reconstruction dataset')
    parser.add_argument('--nevt_rec', type=int, default=20, help='Number of events for validation')
    parser.add_argument('--model', type=str, default='./data/model_GraphPT.pth')
